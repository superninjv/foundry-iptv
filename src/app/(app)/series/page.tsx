// src/app/(app)/series/page.tsx — SERVER COMPONENT
// Watched-only browse: only lists series the current user has actually played.
...
export default async function SeriesPage({
  ...
  try {
    ...
    const items = seriesResult.rows.map((r) => ({
    ...
    return (
      <div className="p-4 pb-20 md:p-6 md:pb-6">
        ...
        <MediaGrid items={items} linkPrefix="/series" />
